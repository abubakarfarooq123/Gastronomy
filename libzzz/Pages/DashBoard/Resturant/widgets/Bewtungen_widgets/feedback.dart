...
//  _storeDetailController.resturantDetails.value.;
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Obx(() => ListView.builder(
                          ...
                          itemCount:
                              ...
                              //     :
                              _storeDetailController.restaurantMenu.value
                    ...
                    Obx(() => _storeDetailController.restaurantMenu.value
                                .responseData.categoryData.length ==
                            0
                        ? Container()
                        //  ctr
                        //                 .subCategory
  ...
  Widget select(index) {
    return Obx(() => InkWell(
          onTap: () async {
            await _storeDetailController.getSubcategoryByCategoryID(
                storeID:
                    _storeDetailController.resturantDetails.value.id.toString(),
                categoryID: _storeDetailController
                    .restaurantMenu.value.responseData.categoryData[index].id
                    .toString());
                  ...
                  child: CircleAvatar(
                    ...
                    child: Container(
                      ...
                      child: SvgPicture.network(
                        _storeDetailController.restaurantMenu.value.responseData
