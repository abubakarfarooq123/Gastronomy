...
//                               .resturantDetails.value.storeProfileImagePath,
//                           width: 100,
//                           height: 100,
//                           fit: BoxFit.cover,
...
//                   ),
//                   Obx((() => Text(
//                         _storeDetailController.resturantDetails.value.storeName,
//                         style: TextStyle(
...
//                             _storeDetailController.resturantDetails.value.id
//                                 .toString();
// //                         _feedbackController.selectedOrderId.value =
// //  _storeDetailController.resturantDetails.value.;
...
//         ),
  ...
  //                                 ? _storeDetailController.subCategory.value
  ...
  //                         })),
  //                   ),
  //                   Obx(() => _dash.forReview.value.orderData.length == 0
  //                       ? Container()
  //                       : _storeDetailController
  //                                   .forReview
  //                                   .value
  ...
  //   return Obx(() => InkWell(
  //         onTap: () {
  //           _feedbackController.selectedMenuId.value = _storeDetailController
  ...
  //                                 .menu
  //                                 .menuImagePath
  //                             : _storeDetailController.forReview.value
  //                                 .orderData[index].variantData.fullImagePath
  //                         : _storeDetailController.forReview.value.orderData[_storeDetailController.forReview.value.orderData.indexWhere((element) => element.menuName.toLowerCase().contains(_feedbackController.searchController.text.toString()))].variantData.fullImagePath ==
  //                                 null
  //                             ? _storeDetailController
  //                                 .forReview
  //                                 .value
  //                                 .orderData[_storeDetailController.forReview.value.orderData
  //                                     .indexWhere((element) => element.menuName
  //                                         .toLowerCase()
  //                                         .contains(_feedbackController.searchController.text
  //                                             .toString()))]
  //                                 .variantData
  //                                 .menu
  //                                 .menuImagePath
  ...
  //                                 .forReview
  //                                 .value
  //                                 .orderData[_storeDetailController
  //                                     .forReview.value.orderData
