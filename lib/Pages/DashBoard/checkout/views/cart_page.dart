                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                        "price: ${controller.selectedMenuItem.value.responseData[index].menuData.price}... ${controller.selectedMenuItem.value.responseData[index].menuVariant.price} ${controller.selectedMenuItem.value.responseData[index].extras}")
                                                  ],
                                                ),
                                              )
                                            ],
