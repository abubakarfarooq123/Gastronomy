...
class SelectedMenuItem {
  ...
  int responseCode;
  String responseText;
  List<SelectedMenuCategory> responseData;

  factory SelectedMenuItem.fromJson(Map<String, dynamic> json) =>
      SelectedMenuItem(
        responseCode: json["ResponseCode"],
        responseText: json["ResponseText"],
        responseData: List<SelectedMenuCategory>.from(
            json["ResponseData"].map((x) => SelectedMenuCategory.fromJson(x))),
      );
...
class SelectedMenuCategory {
  ...
  factory SelectedMenuCategory.fromJson(Map<String, dynamic> json) =>
      SelectedMenuCategory(
        id: json["id"],
